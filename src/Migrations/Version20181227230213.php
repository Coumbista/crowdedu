 ...
 */
final class Version20181227230213 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE projet CHANGE video video VARCHAR(255) NOT NULL, CHANGE user_id user_id_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE projet CHANGE video video VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, CHANGE user_id_id user_id INT DEFAULT NULL');
