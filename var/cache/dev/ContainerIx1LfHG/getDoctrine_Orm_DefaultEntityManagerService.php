...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CategorieRepository' => function () {
    return ($this->privates['App\Repository\CategorieRepository'] ?? $this->load('getCategorieRepositoryService.php'));
}, 'App\\Repository\\ContactRepository' => function () {
    return ($this->privates['App\Repository\ContactRepository'] ?? $this->load('getContactRepositoryService.php'));
}, 'App\\Repository\\DonRepository' => function () {
...
}, 'App\\Repository\\ProjetRepository' => function () {
