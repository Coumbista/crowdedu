...
// Returns the private 'App\Repository\DonRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DonRepository.php';

return $this->privates['App\Repository\DonRepository'] = new \App\Repository\DonRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
