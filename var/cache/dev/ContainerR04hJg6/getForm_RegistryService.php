...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\CategorieType' => function () {
    return ($this->privates['App\Form\CategorieType'] ?? $this->privates['App\Form\CategorieType'] = new \App\Form\CategorieType());
}, 'App\\Form\\ContactType' => function () {
    return ($this->privates['App\Form\ContactType'] ?? $this->privates['App\Form\ContactType'] = new \App\Form\ContactType());
}, 'App\\Form\\Don1Type' => function () {
    return ($this->privates['App\Form\Don1Type'] ?? $this->privates['App\Form\Don1Type'] = new \App\Form\Don1Type());
}, 'App\\Form\\DonType' => function () {
    return ($this->privates['App\Form\DonType'] ?? $this->privates['App\Form\DonType'] = new \App\Form\DonType());
}, 'App\\Form\\Projet1Type' => function () {
    return ($this->privates['App\Form\Projet1Type'] ?? $this->privates['App\Form\Projet1Type'] = new \App\Form\Projet1Type());
}, 'App\\Form\\ProjetType' => function () {
    return ($this->privates['App\Form\ProjetType'] ?? $this->privates['App\Form\ProjetType'] = new \App\Form\ProjetType());
