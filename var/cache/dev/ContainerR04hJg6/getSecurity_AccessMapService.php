...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/dashboard'), array(0 => 'ROLE_ADMIN'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/etudiant'), array(0 => 'ROLE_USER'), NULL);
