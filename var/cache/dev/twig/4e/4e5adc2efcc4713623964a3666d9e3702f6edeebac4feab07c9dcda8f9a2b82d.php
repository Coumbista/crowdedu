...
class __TwigTemplate_bcfac56940c1a6d6b25beccc12b68cf4166ade52afe2c56a8cb64bf765aefadb extends Twig_Template
{
    private $source;
    ...
    public function macro_set_handler($__controller__ = null, $__route__ = null, $__method__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["controller"] ?? null), "class", array(), "any", true, true)) {
                // line 290
                if (((array_key_exists("method", $context)) ? (_twig_default_filter((isset($context["method"]) || array_key_exists("method", $context) ? $context["method"] : (function () { throw new Twig_Error_Runtime('Variable "method" does not exist.', 290, $this->source); })()), false)) : (false))) {
                ...
                // line 294
                if (((array_key_exists("route", $context)) ? (_twig_default_filter((isset($context["route"]) || array_key_exists("route", $context) ? $context["route"] : (function () { throw new Twig_Error_Runtime('Variable "route" does not exist.', 294, $this->source); })()), false)) : (false))) {
                    // line 295
                    echo "@";
...
{% macro set_handler(controller, route, method) %}
    ...
    {%- endif %}
{% endmacro %}
", "@WebProfiler/Collector/request.html.twig", "/home/coumba/crowdedu/FundingEdu/vendor/symfony/web-profiler-bundle/Resources/views/Collector/request.html.twig");
    }
}
